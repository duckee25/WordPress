<?php
$output = $title = $link = $size = $zoom = $type = $bubble = $el_class = $vc_css = '';
...
$vc_css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, vc_shortcode_custom_css_class( $vc_css, ' ' ) );
...
?>
<div class="<?php echo $css_class; ?><?php echo $vc_css_class; ?>">
